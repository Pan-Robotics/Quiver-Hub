...
scp raspberry_pi_client.py alexd@your-pi-ip:/home/alexd/
```

### Make Executable

```bash
chmod +x /home/alexd/raspberry_pi_client.py
```
...
```bash
python3 /home/alexd/raspberry_pi_client.py \
...
Type=simple
User=alexd
WorkingDirectory=/home/alexd
ExecStart=/usr/bin/python3 /home/alexd/raspberry_pi_client.py --server https://your-quiver-hub.com --drone-id quiver_001 --api-key your-api-key-here
Restart=always
RestartSec=10
...
```json
{
  ...
  "targetPath": "/home/alexd/parsers/sensor_parser.py",
...
```json
{
  ...
  "configFile": "/home/alexd/config/quiver_config.json"
}
```
...
4. Set **Target Path** (e.g., `/home/alexd/parsers/my_parser.py`)
...
cat /home/alexd/config/quiver_config.json
```
